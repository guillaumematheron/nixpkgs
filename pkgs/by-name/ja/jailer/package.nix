...
stdenv.mkDerivation rec {
  ...
  installPhase = ''
    ...
    install -Dm644 jailer-engine-16.1.4.jar $out/share/java/
  ...
  meta = with lib; {
    description = "Jailer is a tool for database subsetting and relational data browsing";
    license = licenses.asl20;
    homepage = "https://github.com/Wisser/Jailer";
    changelog = "https://github.com/Wisser/Jailer/releases/tag/${version}";
